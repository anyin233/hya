...
export const Definitions = {
  ...
  pane_roster: keybind("<leader>o", "Open subagent roster"),
  pane_open_tab: keybind("<leader>T", "Open subagent in tab"),
  pane_open_vertical: keybind("<leader>V", "Open subagent in vertical split"),
  pane_open_horizontal: keybind("<leader>S", "Open subagent in horizontal split"),
  pane_close: keybind("<leader>w", "Close focused pane"),
  pane_cycle: keybind("<leader>.,<leader>right", "Cycle pane focus forward"),
  pane_cycle_reverse: keybind("<leader>left", "Cycle pane focus backward"),
  pane_focus_main: keybind("<leader>0", "Focus Main pane"),
  ...
  agent_models: keybind("none", "Configure agent models"),
  ...
  prompt_submit_steer: keybind("ctrl+alt+return", "Abort the current turn and send the prompt now"),
  prompt_submit_queue: keybind("none", "Queue the prompt until the current turn finishes"),
  queued_prompt_delete: keybind("ctrl+d", "Delete a queued prompt"),
...
export const CommandMap = {
  ...
  pane_open_tab: "pane.open.tab",
  pane_open_vertical: "pane.open.vertical",
  pane_open_horizontal: "pane.open.horizontal",
  pane_close: "pane.close",
  pane_cycle: "pane.cycle",
  pane_cycle_reverse: "pane.cycle.reverse",
  ...
  prompt_submit_queue: "prompt.submit.queue",
