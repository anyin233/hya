# Compat TUI Reference Notes

Reference source:

- Repository: `https://github.com/anomalyco/compat`
- Local clone: `/tmp/yaca-compat-ref`
- Commit: `f12ac6f234ebe31982ee78f3359e8170cb09ffc9`

## Relevant Compat Paths
...
- The user explicitly wants Claude Code/Compat-like paste UX: pasted text
...
- Split `widgets.rs` into modules so each Compat concept has a Rust peer:
