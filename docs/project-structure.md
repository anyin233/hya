...
| `hya-render-tui` | [`../crates/hya-render-tui/src/lib.rs`](../crates/hya-render-tui/src/lib.rs) | Pure ratatui view state, layout, theme, view-model conversion, and widgets. |
| `hya-cli` | [`../crates/hya-cli/src/main.rs`](../crates/hya-cli/src/main.rs) | Umbrella binary: TUI, `run`/`exec`, goal mode, server, tail-session, config/auth, MCP/plugin setup. |
...
The current interactive TUI runs in-process through `hya-cli`; it does not need
the HTTP client to render local conversations.

## `hya-render-tui` and `hya-cli`

`hya-render-tui` is pure rendering. It owns:
...
`hya-cli/src/tui.rs` owns terminal side effects:
...
| Module | Purpose |
| --- | --- |
| [`lib.rs`](../crates/hya-render-tui/src/lib.rs) | Public `AppState`, prompt/view structs, and top-level `draw`. |
| [`layout.rs`](../crates/hya-render-tui/src/layout.rs) | Responsive terminal regions: status, timeline, optional sidebar, prompt, footer. |
| [`theme.rs`](../crates/hya-render-tui/src/theme.rs) | Named color/style tokens for the dark terminal theme. |
| [`view_model.rs`](../crates/hya-render-tui/src/view_model.rs) | Converts projections into timeline items, including text, reasoning, and tools. |
| [`widgets.rs`](../crates/hya-render-tui/src/widgets.rs) | Renders status, timeline, sidebar, prompt, footer, permission panel, and cursor. |

This split keeps rendering testable in [`../crates/hya-render-tui/tests`](../crates/hya-render-tui/tests).
...
| [`../crates/hya-render-tui/tests`](../crates/hya-render-tui/tests) | Rendering snapshots, permission panel, scroll behavior, tool lines. |
