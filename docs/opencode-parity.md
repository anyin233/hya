...
| TUI control API | Minimal `/tui/publish`, `/tui/control/next`, and `/tui/control/response` queue routes exist. Missing direct append/open/help/models/themes/submit/clear/execute/toast/select routes and real TUI main-loop integration. |
