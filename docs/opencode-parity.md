...
permission/question queue, project copy, project metadata/init, MCP status, and
v2 filesystem compatibility, plus legacy session todo compatibility increments.
