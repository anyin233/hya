...
/** One Skill declaration published by an extension initialize handshake. */
export type SkillContribution = {
  /** Stable Skill identifier in the plugin contribution namespace. */
  readonly id: string
  /** Complete Skill content supplied by the extension. */
  readonly content: string
  /** Exact content digest supplied by the extension. */
  readonly digest: string
}

/** One hook registration emitted by the Bun adapter. */
export type HookRegistration = {
  /** Wire hook name understood by the hya host. */
  readonly name: string
}

/** One workspace adapter metadata declaration emitted by the Bun adapter. */
...
export type PluginContributionSet = {
  /** Hook registrations produced by the loaded extensions. */
  readonly hooks: readonly HookRegistration[]
  /** Tool declarations produced by the loaded extensions. */
  readonly tools: readonly ToolInfo[]
  /** Skill declarations produced by the loaded extensions. */
  readonly skills: readonly SkillContribution[]
  /** Workspace adapter registrations produced by the loaded extensions. */
