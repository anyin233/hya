...
pub struct ConnectRelayRequest {
    ...
    #[prost(string, tag = "3")]
    pub extra_ca_path: ::prost::alloc::string::String,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ConnectRelayResponse {
    /// The connector's state right after starting.
    #[prost(message, optional, tag = "1")]
    pub status: ::core::option::Option<RelayStatus>,
    /// The full relay link (secret).
    #[prost(string, tag = "2")]
    pub link: ::prost::alloc::string::String,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct DisconnectRelayRequest {}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct GetRelayStatusRequest {}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct GetRelayLinkRequest {}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct RotateRelayKeyRequest {}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct RelayStatus {
    /// Connector state.
    #[prost(enumeration = "RelayState", tag = "1")]
    pub state: i32,
    ...
    #[prost(string, tag = "4")]
    pub redacted_link: ::prost::alloc::string::String,
    ...
    #[prost(string, tag = "7")]
    pub binding_reason: ::prost::alloc::string::String,
    ...
    #[prost(message, optional, tag = "9")]
    pub connected_since: ::core::option::Option<::pbjson_types::Timestamp>,
...
impl RelayState {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "RELAY_STATE_UNSPECIFIED" => Some(Self::Unspecified),
            "RELAY_STATE_DISCONNECTED" => Some(Self::Disconnected),
            "RELAY_STATE_CONNECTING" => Some(Self::Connecting),
            "RELAY_STATE_CONNECTED" => Some(Self::Connected),
            "RELAY_STATE_BACKOFF" => Some(Self::Backoff),
            _ => None,
        }
    }
}
/// Generated client implementations.
pub mod relay_control_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    #[derive(Debug, Clone)]
    pub struct RelayControlClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl RelayControlClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> RelayControlClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            RelayControlClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn connect_relay(
            &mut self,
            request: impl tonic::IntoRequest<super::ConnectRelayRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ConnectRelayResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/hya.v1.RelayControl/ConnectRelay",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hya.v1.RelayControl", "ConnectRelay"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn disconnect_relay(
            &mut self,
            request: impl tonic::IntoRequest<super::DisconnectRelayRequest>,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/hya.v1.RelayControl/DisconnectRelay",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hya.v1.RelayControl", "DisconnectRelay"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn get_relay_status(
            &mut self,
            request: impl tonic::IntoRequest<super::GetRelayStatusRequest>,
        ) -> std::result::Result<tonic::Response<super::RelayStatus>, tonic::Status> {
            self.inner
                .ready()
                .await
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/hya.v1.RelayControl/GetRelayStatus",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hya.v1.RelayControl", "GetRelayStatus"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn get_relay_link(
            &mut self,
            request: impl tonic::IntoRequest<super::GetRelayLinkRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RelayLinkResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/hya.v1.RelayControl/GetRelayLink",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hya.v1.RelayControl", "GetRelayLink"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn rotate_relay_key(
            &mut self,
            request: impl tonic::IntoRequest<super::RotateRelayKeyRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RelayLinkResponse>,
            tonic::Status,
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/hya.v1.RelayControl/RotateRelayKey",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hya.v1.RelayControl", "RotateRelayKey"));
            self.inner.unary(req, path, codec).await
        }
    }
}
/// Generated server implementations.
pub mod relay_control_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with RelayControlServer.
    #[async_trait]
    pub trait RelayControl: std::marker::Send + std::marker::Sync + 'static {
        /// Join a relay: load (or create) the relay identity and keep a host
        /// control stream to `proxy_url`, reconnecting with backoff. Replaces any
        /// current relay connection. Returns once the connector runs, before the
        /// room is registered (see `GetRelayStatus`). `invalid_argument` for an
        ...
        async fn connect_relay(
            &self,
            request: tonic::Request<super::ConnectRelayRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ConnectRelayResponse>,
            tonic::Status,
        >;
        ...
        async fn disconnect_relay(
            &self,
            request: tonic::Request<super::DisconnectRelayRequest>,
        ) -> std::result::Result<tonic::Response<super::RelayStatus>, tonic::Status>;
        /// The connector's state. Never contains key material.
        ///
        /// hya.http: GET /v1/relay/status
        async fn get_relay_status(
            &self,
            request: tonic::Request<super::GetRelayStatusRequest>,
        ) -> std::result::Result<tonic::Response<super::RelayStatus>, tonic::Status>;
        /// The full relay link — a secret: whoever holds it controls this backend.
        /// `failed_precondition` while not connected to a relay.
        ///
        ...
        async fn get_relay_link(
            &self,
            request: tonic::Request<super::GetRelayLinkRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RelayLinkResponse>,
            tonic::Status,
        >;
        ...
        async fn rotate_relay_key(
            &self,
            request: tonic::Request<super::RotateRelayKeyRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RelayLinkResponse>,
            tonic::Status,
        >;
    ...
    /// or `Sec-Fetch-Site` header).
    #[derive(Debug)]
    pub struct RelayControlServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for RelayControlServer<T>
    where
        T: RelayControl,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/hya.v1.RelayControl/ConnectRelay" => {
                    #[allow(non_camel_case_types)]
                    struct ConnectRelaySvc<T: RelayControl>(pub Arc<T>);
                    impl<
                        T: RelayControl,
                    > tonic::server::UnaryService<super::ConnectRelayRequest>
                    for ConnectRelaySvc<T> {
                        type Response = super::ConnectRelayResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RelayControl>::connect_relay(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ConnectRelaySvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/hya.v1.RelayControl/DisconnectRelay" => {
                    #[allow(non_camel_case_types)]
                    struct DisconnectRelaySvc<T: RelayControl>(pub Arc<T>);
                    impl<
                        T: RelayControl,
                    > tonic::server::UnaryService<super::DisconnectRelayRequest>
                    for DisconnectRelaySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RelayControl>::disconnect_relay(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DisconnectRelaySvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/hya.v1.RelayControl/GetRelayStatus" => {
                    #[allow(non_camel_case_types)]
                    struct GetRelayStatusSvc<T: RelayControl>(pub Arc<T>);
                    impl<
                        T: RelayControl,
                    > tonic::server::UnaryService<super::GetRelayStatusRequest>
                    for GetRelayStatusSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RelayControl>::get_relay_status(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/hya.v1.RelayControl/GetRelayLink" => {
                    #[allow(non_camel_case_types)]
                    struct GetRelayLinkSvc<T: RelayControl>(pub Arc<T>);
                    impl<
                        T: RelayControl,
                    > tonic::server::UnaryService<super::GetRelayLinkRequest>
                    for GetRelayLinkSvc<T> {
                        type Response = super::RelayLinkResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RelayControl>::get_relay_link(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetRelayLinkSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/hya.v1.RelayControl/RotateRelayKey" => {
                    #[allow(non_camel_case_types)]
                    struct RotateRelayKeySvc<T: RelayControl>(pub Arc<T>);
                    impl<
                        T: RelayControl,
                    > tonic::server::UnaryService<super::RotateRelayKeyRequest>
                    for RotateRelayKeySvc<T> {
                        type Response = super::RelayLinkResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RelayControl>::rotate_relay_key(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RotateRelayKeySvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for RelayControlServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "hya.v1.RelayControl";
    impl<T> tonic::server::NamedService for RelayControlServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
