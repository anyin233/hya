...
//!
//! Oneshots the SSE route on the in-process yaca `Router` and drains its streaming body in-process,
//! reusing the backend's `Envelope -> GlobalEvent` projection (`yaca-server/src/opencode/event.rs`)
