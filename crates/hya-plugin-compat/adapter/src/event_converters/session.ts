...
import type { EventEnvelope, CompatEvent } from "./types"

export function sessionCreatedEvent(envelope: EventEnvelope): CompatEvent | undefined {
...
export function sessionTitledEvent(envelope: EventEnvelope): CompatEvent | undefined {
  const session = stringField(envelope.event, "session")
...
export function commandExecutedEvent(envelope: EventEnvelope): CompatEvent | undefined {
  const session = stringField(envelope.event, "session")
...
export function messageStartedEvent(envelope: EventEnvelope): CompatEvent | undefined {
  const session = stringField(envelope.event, "session")
  const message = stringField(envelope.event, "message")
...
export function messageFinishedEvent(envelope: EventEnvelope): CompatEvent | undefined {
  const session = stringField(envelope.event, "session")
  const message = stringField(envelope.event, "message")
  const role = stringField(envelope.event, "role")
  if (session === undefined || message === undefined) {
...
export function errorEvent(envelope: EventEnvelope): CompatEvent | undefined {
  const message = stringField(envelope.event, "message")
