//! Integration tests for `hya-server`: compat prompt async api.
...
use compat_prompt_async_support::{create_session, get_messages, post_prompt_async, state};

#[tokio::test]
async fn compat_prompt_async_returns_no_content_and_records_messages() {
