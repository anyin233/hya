//! Integration tests for `hya-server`: compat doc api.
...
async fn state() -> AppState {
    ...
    AppState::new(
        ...
        Arc::new(AgentSpec {
            ...
            workdir: "/tmp/hya-compat-doc-api".into(),
            reasoning: None,
        }),
    )
}
...
#[tokio::test]
async fn compat_doc_route_returns_openapi_document() {
...
#[tokio::test]
async fn compat_openapi_json_route_returns_openapi_document() {
    let app = router(state().await);
