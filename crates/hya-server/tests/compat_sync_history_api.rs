//! Integration tests for `hya-server`: compat sync history api.
...
const WORKDIR: &str = "/tmp/hya-compat-sync-history-api";
...
#[tokio::test]
async fn compat_sync_history_returns_events_after_known_sequences() {
