...
const WORKDIR: &str = "/tmp/hya-opencode-session-title-api";
...
#[tokio::test]
async fn opencode_title_replaces_root_fallback_with_clean_title_output() {
    let app = router(
...
#[tokio::test]
async fn opencode_title_does_not_replace_child_session_title() {
    let app = router(
        state_with_script(vec![vec![
...
#[tokio::test]
async fn opencode_title_does_not_replace_manual_title() {
    let app = router(
        state_with_script(vec![vec![
...
#[tokio::test]
async fn opencode_prompt_async_replaces_root_fallback_with_clean_title_output() {
    let app = router(
