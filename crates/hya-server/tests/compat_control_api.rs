//! Integration tests for `hya-server`: compat control api.
...
const WORKDIR: &str = "/tmp/hya-compat-control-api";
...
#[tokio::test]
async fn compat_log_route_accepts_sdk_log_entries() {
...
#[tokio::test]
async fn compat_auth_routes_persist_and_remove_hya_tokens() {
