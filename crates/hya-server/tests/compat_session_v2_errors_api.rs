//! Integration tests for `hya-server`: compat session v2 errors api.
...
const WORKDIR: &str = "/tmp/hya-compat-session-v2-errors-api";
...
#[tokio::test]
async fn compat_v2_session_missing_routes_return_typed_not_found_errors() {
