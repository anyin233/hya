//! Integration tests for `hya-server`: compat session v2 context api.
...
const WORKDIR: &str = "/tmp/hya-compat-session-v2-context-api";
...
#[tokio::test]
async fn compat_v2_context_completed_tool_content_matches_compat_shape() {
