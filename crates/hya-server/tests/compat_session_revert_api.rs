//! Integration tests for `hya-server`: compat session revert api.
...
use hya_proto::{AgentName, FinishReason, ModelRef, PartId, SessionId};
...
#[tokio::test]
async fn compat_session_revert_missing_message_id_is_noop() {
...
#[tokio::test]
async fn compat_session_revert_rejects_foreign_part_id_as_noop() {
...
#[tokio::test]
async fn compat_session_revert_scopes_diff_to_matching_part_id() {
...
#[tokio::test]
async fn compat_session_revert_missing_session_returns_not_found() {
...
#[tokio::test]
async fn compat_session_revert_rejects_busy_sessions() {
