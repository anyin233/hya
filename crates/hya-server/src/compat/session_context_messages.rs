...
pub(in crate::compat) fn v2_messages(envs: &[Envelope], projection: &Projection) -> Vec<Value> {
    let times = message_times(envs);
    let part_context = super::message_parts::CompatPartContext::new(envs);
...
fn message_json(
    ...
    part_context: &super::message_parts::CompatPartContext,
