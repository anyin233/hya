...
const AGENT_BUNDLE_AUTHORING_DESCRIPTION: &str = "Use when authoring and packaging 0.34.10 public-static AgentBundles: strict bundle.hya.md archives, install/info commands, stable AgentName bytes, role/selector, can_spawn, harness_access, resource_view, and private inspection boundaries. Do not use for compat opencode.json customization or executable bundle runners.";
