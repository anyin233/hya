...
use yaca_proto::{Envelope, Event, PartId, ToolPartState};

#[derive(Clone, Copy, Default)]
pub(in crate::opencode) struct ToolTime {
    created: Option<u64>,
    ran: Option<u64>,
    completed: Option<u64>,
}

pub(in crate::opencode) fn tool_times(envs: &[Envelope]) -> BTreeMap<PartId, ToolTime> {
...
pub(in crate::opencode) fn tool_time(time: Option<ToolTime>) -> Value {
