...
use crate::sync_opencode::config_merge::{
    existing_mcp_names, merge_managed_mcp, remove_managed_mcp,
};
use crate::sync_opencode::discover::{McpCandidate, SkillCandidate};
