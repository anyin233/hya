...
#[test]
fn sync_compat_apply_creates_symlink_and_lockfile() {
    let root = tempdir("sync-compat-apply");
    ...
    let lockfile = hya_config_home.join("hya/compat-sync-lock.json");
...
#[test]
fn sync_compat_apply_is_idempotent_on_second_run() {
    let root = tempdir("sync-compat-idempotent");
    let compat_skill_root = root.join("compat-skills");
    let hya_config_home = root.join("xdg");
    let hya_skill_root = hya_config_home.join("hya/skills");
    let compat_config = root.join("opencode.json");
    ...
    let first_lock = std::fs::read_to_string(hya_config_home.join("hya/compat-sync-lock.json"))
    ...
    let second_lock = std::fs::read_to_string(hya_config_home.join("hya/compat-sync-lock.json"))
...
#[test]
fn sync_compat_apply_preserves_unmanaged_mcp_entries() {
    let root = tempdir("sync-compat-preserve-mcp");
    let compat_skill_root = root.join("compat-skills");
    let hya_config_home = root.join("xdg");
    let hya_skill_root = hya_config_home.join("hya/skills");
    let compat_config = root.join("opencode.json");
...
#[test]
fn sync_compat_apply_does_not_duplicate_existing_same_named_mcp() {
    let root = tempdir("sync-compat-existing-mcp");
    let compat_skill_root = root.join("compat-skills");
    let hya_config_home = root.join("xdg");
    let hya_skill_root = hya_config_home.join("hya/skills");
    let compat_config = root.join("opencode.json");
...
#[test]
fn sync_compat_apply_skips_user_authored_skill_directory() {
    let root = tempdir("sync-compat-skill-conflict");
    let compat_skill_root = root.join("compat-skills");
    let hya_config_home = root.join("xdg");
    let hya_skill_root = hya_config_home.join("hya/skills");
    let compat_config = root.join("opencode.json");
    ...
    std::fs::create_dir_all(hya_config.parent().expect("hya config parent"))
        .expect("create hya config parent");
    write_skill(&compat_skill_root, "plan-review", "incoming skill");
...
#[test]
fn sync_compat_apply_migrates_mcp_environment() {
    let root = tempdir("sync-compat-mcp-env");
    let compat_skill_root = root.join("compat-skills");
    let hya_config_home = root.join("xdg");
    let hya_skill_root = hya_config_home.join("hya/skills");
    let compat_config = root.join("opencode.json");
