...
Create a maintainable `docs/` information architecture for hya and populate it
...
- Keep documentation focused on hya itself. Do not document `.trellis/`, the
...
- [ ] Usage docs explain installation/build assumptions, `hya`, `hya exec`,
...
- Reference projects checked: OpenCode public docs use a broad topic-page model;
  Oh My Pi docs use deeper engineering-topic manuals. hya should use a smaller
