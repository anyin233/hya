...
- Bump the project to version `0.33.11` and archive the previous root changelog according to the project release rule.
...
- [x] README, root `CHANGELOG.md`, root `Cargo.toml`, packaged TypeScript TUI manifest, and every hya package in `Cargo.lock` agree on `0.33.11`.
- [x] Previous root changelog content is archived at `docs/changes/CHANGELOG_0.33.10.md`.
